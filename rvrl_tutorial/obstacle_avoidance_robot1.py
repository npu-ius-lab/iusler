...
class ObstacleAvoidance(Node):
    ...
    def __init__(self):
        ...
        self.scan = self.create_subscription(LaserScan, '/robot1/scan', self.scan_callback, 10)
    ...
    def scan_callback(self,msg):
        print(msg._angle_min,msg._angle_max,msg._angle_increment,msg._range_min,msg._range_max)
